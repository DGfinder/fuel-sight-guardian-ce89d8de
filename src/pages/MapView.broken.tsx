...
// Create SVG icon strings to avoid template literal parsing issues
const createTankIconSvg = (fillColor: string, size = "24 36") => {
  const svg = [
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ' + size + '" width="24" height="36">',
    '<path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" fill="' + fillColor + '" stroke="#ffffff" stroke-width="2"/>',
...
const createUserIconSvg = (fillColor: string) => {
  const svg = [
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">',
    '<circle cx="12" cy="12" r="10" fill="' + fillColor + '" stroke="#ffffff" stroke-width="3"/>',
...
const TANK_ICONS = {
  critical: new L.Icon({
    iconUrl: createTankIconSvg(semanticColors.tankCritical),
    iconSize: [24, 36],
    iconAnchor: [12, 36],
    popupAnchor: [0, -36],
  }),
  low: new L.Icon({
    iconUrl: createTankIconSvg(semanticColors.tankLow),
    iconSize: [24, 36],
    iconAnchor: [12, 36],
    popupAnchor: [0, -36],
  }),
  normal: new L.Icon({
    iconUrl: createTankIconSvg(semanticColors.tankNormal),
    iconSize: [24, 36],
    iconAnchor: [12, 36],
    popupAnchor: [0, -36],
  }),
  default: new L.Icon({
    iconUrl: createTankIconSvg(semanticColors.tankUnknown),
    iconSize: [24, 36],
    iconAnchor: [12, 36],
    popupAnchor: [0, -36],
  }),
  user: new L.Icon({
    iconUrl: createUserIconSvg(semanticColors.textPrimary),
    iconSize: [24, 24],
    iconAnchor: [12, 12],
    popupAnchor: [0, -12],
  }),
...
function MapView() {
  ...
  const handleExportTanks = () => {
    ...
    // Escape quotes in CSV fields using replaceAll to avoid regex parsing issues
