...
# Read the file
with open('src/components/AgbotDetailsModal.tsx', 'r', encoding='utf-8') as f:
    lines = f.readlines()

# Lines 1-277 (index 0-276) - everything before Analytics Tab
before_analytics = ''.join(lines[:277])

# Lines 572 onwards (index 571+) - Device Tab and everything after
after_analytics = ''.join(lines[571:])
...
# Combine the parts
new_content = before_analytics + analytics_tab + after_analytics

# Write the updated content
with open('src/components/AgbotDetailsModal.tsx', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Successfully updated Analytics Tab!")
