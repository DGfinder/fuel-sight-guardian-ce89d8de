-- ============================================================================
-- RUN CORRELATION SYSTEM MIGRATIONS
-- Execute these migrations in order to set up the complete correlation system
-- ============================================================================
...
-- Step 2: Create the correlation system (if not already done)
-- This will create the mtdata_captive_correlations table and related objects
-- Note: Copy the content from create_mtdata_captive_correlations.sql here if needed

-- Step 3: Create the hybrid correlation engine functions
-- Note: Copy the content from hybrid_correlation_engine.sql here

-- Step 4: Create the geospatial matching functions  
-- Note: Copy the content from geospatial_trip_terminal_matching.sql here

-- Step 5: Upgrade to the hybrid correlation system
-- Note: Copy the content from upgrade_correlation_system_hybrid_fixed.sql here

-- Step 6: Verify the setup
SELECT 
  'Correlation System Setup Status' as check_type,
  ...
  (SELECT COUNT(*) FROM information_schema.routines WHERE routine_name = 'run_batch_correlation_analysis') as batch_function_exists,
...
SELECT 
  ...
  '1. Run the correlation function creation files' as step_1,
  '2. Run the upgrade migration' as step_2,
  '3. Test the correlation system' as step_3;
